      ...
      return (
        <div className="fitted layout list card">
          {objects.length > 0 ? (
            ...
            <div className="fitted center column layout">
              <div style={{ fontSize: '20px', marginBottom: '20px', fontWeight: 300 }}>No results to show</div>
              {moonless ? (
                <div style={{ color: '#444' }}>
                  Try to turn off the <i>Moonless night only</i> filter
                </div>
              ) : null}
            </div>
          )}
